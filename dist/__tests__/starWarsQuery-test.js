...
describe("Star Wars Query Tests", () => {
    ...
    describe("Basic Queries", () => {
      ...
      `;
            const result = await graphql_1.graphql(starWarsSchema_1.default, source);
            expect(result).toEqual({
                data: {
                    hero: {
                        name: "R2-D2",
            ...
            const syncResult = graphql_1.graphqlSync(starWarsSchema_1.default, source);
    ...
    describe("Using IDs and query parameters to refetch objects", () => {
      ...
      `;
            ...
            const result = await graphql_1.graphql({ schema: starWarsSchema_1.default, source, variableValues });
            expect(result).toEqual({
                data: {
                    human: {
                        name: "Luke Skywalker",
